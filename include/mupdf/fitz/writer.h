...
FZ_DATA_DECLARATION extern const char *fz_pdf_write_options_usage;
FZ_DATA_DECLARATION extern const char *fz_svg_write_options_usage;

FZ_DATA_DECLARATION extern const char *fz_pcl_write_options_usage;
FZ_DATA_DECLARATION extern const char *fz_pclm_write_options_usage;
FZ_DATA_DECLARATION extern const char *fz_pwg_write_options_usage;
FZ_DATA_DECLARATION extern const char *fz_pdfocr_write_options_usage;
