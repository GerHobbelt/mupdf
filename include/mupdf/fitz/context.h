...
enum fz_error_type ENUM_IS_UNSIGNED_INT_TYPE /* fix warning C4865: the underlying type will change from 'int' to 'unsigned int' when '/Zc:enumTypes' is specified on the command line */
{
	FZ_ERROR_NONE,
	FZ_ERROR_GENERIC,
