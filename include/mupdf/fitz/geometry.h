...
/**
	...
	is at (1, 1).
*/
FZ_EXPORT_DATA extern const fz_rect fz_unit_rect;

/**
	An empty rectangle with an area equal to zero.
*/
FZ_EXPORT_DATA extern const fz_rect fz_empty_rect;
FZ_EXPORT_DATA extern const fz_irect fz_empty_irect;

/**
	An infinite rectangle.
*/
FZ_EXPORT_DATA extern const fz_rect fz_infinite_rect;
FZ_EXPORT_DATA extern const fz_irect fz_infinite_irect;
...
*/
FZ_EXPORT_DATA extern const fz_matrix fz_identity;
