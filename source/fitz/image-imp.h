 ...
 */
#if FZ_ENABLE_JPX
void fz_load_jpx_info(fz_context *ctx, const unsigned char *data, size_t size, int *wp, int *hp, int *xresp, int *yresp, fz_colorspace **cspacep, fz_colorspace *defcs, uint8_t *orientation);
#endif
