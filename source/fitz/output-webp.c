...
fz_buffer *
fz_new_buffer_from_image_as_webp(fz_context *ctx, fz_image *image, fz_color_params color_params)
{
...
fz_buffer *
fz_new_buffer_from_pixmap_as_webp(fz_context *ctx, fz_pixmap *pix, fz_color_params color_params)
{
	return webp_from_pixmap(ctx, pix, color_params, 0);
}
