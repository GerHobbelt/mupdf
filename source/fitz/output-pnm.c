...
buffer_from_bitmap(fz_context *ctx, fz_bitmap *bitmap, fz_color_params color_params, int drop,
	void (*do_write)(fz_context *ctx, fz_output *out, const fz_bitmap *bitmap))
{
	fz_buffer *buf = NULL;
	fz_output *out = NULL;
...
fz_buffer *
fz_new_buffer_from_pixmap_as_pbm(fz_context *ctx, const fz_pixmap *pix, fz_color_params color_params)
{
...
fz_buffer *
fz_new_buffer_from_image_as_pbm(fz_context *ctx, const fz_image *image, fz_color_params color_params)
{
...
fz_buffer *
fz_new_buffer_from_pixmap_as_pkm(fz_context *ctx, const fz_pixmap *pix, fz_color_params color_params)
{
	fz_bitmap *bitmap = fz_new_bitmap_from_pixmap(ctx, pix, NULL);
...
fz_buffer *
fz_new_buffer_from_image_as_pkm(fz_context *ctx, const fz_image *image, fz_color_params color_params)
{
	fz_bitmap *bitmap = fz_new_bitmap_from_image(ctx, image, NULL);
	return  buffer_from_bitmap(ctx, bitmap, color_params, 1, fz_write_bitmap_as_pkm);
}
