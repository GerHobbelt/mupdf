...
static struct tool_spec {
	...
	{ {.fa = qiqqa_mucontent_main }, "doc_content", "qiqqa::doc_content tool" },
	{ {.fa = qiqqa_doc_scrutinizer_main }, "doc_scrutinizer", "qiqqa::doc_scrutinizer tool" },
	{ {.fa = qiqqa_documentid62_main }, "documentid62", "qiqqa::documentid62 tool" },
	{ {.fa = qiqqa_fingerprint0_main }, "fingerprint0", "qiqqa::fingerprint0 tool" },
	{ {.fa = qiqqa_fingerprint1_main }, "fingerprint1", "qiqqa::fingerprint1 tool" },
	...
	{ {.fa = qiqqa_muserver_main }, "muserver", "qiqqa::muserver tool" },
	{ {.fa = qiqqa_ocr_bezoar_main }, "ocr_bezoar", "qiqqa::ocr_bezoar tool" },
	{ {.fa = qiqqa_muannot_main }, "pdf_annot", "qiqqa::pdf_annot tool" },
