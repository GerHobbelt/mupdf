...
{
	fz_info(ctx,
		"qcvtannotblob: convert lecagy Qiqqa binary encoded annotation blobs from the database to generally usable JSON format.\n"
		"\n"
		"Syntax: qcvtannotblob [options] <blobfile>\n"
		"\n"
		"Options:\n"
