...
node ./sync-sln-files.js 2 $( find . -maxdepth 1 -type f -name '*.sln' )

node ./sync-sln-files.js 3 m-dev-list.sln  *failed-ideas*.sln *obnoxious-to-be-evaluated*.sln *may-matter*.sln
