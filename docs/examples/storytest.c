...
const char content[] =
	...
	"<p style=\"leading:7pt;\">It strongly advised that the Butcher should be<br>"
	...
	"<p style=\"leading:11pt;\">Navigation was always a difficult art,<br>"
