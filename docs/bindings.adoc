...
* Install Python using the Python Windows installer from the Python website:
...
* On Windows, runs `devenv.com` on Windows `.sln` and `.vcxproj` files in `platform/win32`.
