...
.. method:: toStructuredText(options)
    ...
    Extract the text on the page into a `StructuredText` object. The options argument is a comma separated list of flags: "preserve-ligatures", "preserve-whitespace", "preserve-spans", "preserve-images", "inhibit-spaces", "dehyphenate", "structured", "use-cid-for-unknown-unicode", and "inhibit-actualtext".
