...
def make_function_wrapper( tu, cursor, fnname, out_h, out_cpp, out_swig_c, out_swig_python):
    ...
    out_h.write( f'mupdf_EXPORT {declaration_h};\n')
    out_h.write( '\n')

    # Write function definition.
    #
    out_cpp.write( f'mupdf_EXPORT {declaration_cpp}\n')
    out_cpp.write( '{\n')
...
def class_copy_constructor(
    ...
    for fnname, cursor, duplicate_type in constructor_fns:
        ...
        out_h.write( f'    mupdf_EXPORT {classname}(const {classname}& rhs);\n')
        out_h.write( '\n')
        ...
        out_cpp.write( f'mupdf_EXPORT {classname}::{classname}(const {classname}& rhs)\n')
    ...
    out_h.write( f'    /* {comment} */\n')
    out_h.write( f'    mupdf_EXPORT {classname}& operator=(const {classname}& rhs);\n')

    out_cpp.write( f'/* {comment} */\n')
    out_cpp.write( f'mupdf_EXPORT {classname}& {classname}::operator=(const {classname}& rhs)\n')
    out_cpp.write(  '{\n')
...
def class_write_method(
    ...
    out_h.write( f'    mupdf_EXPORT {"static " if static else ""}{fn_h};\n')
    if duplicate_type:
        out_h.write( f'    */\n')
    ...
    out_cpp.write( f'mupdf_EXPORT {fn_cpp}\n')
...
def class_raw_constructor(
    ...
    if extras.constructor_raw == 'default':
        out_h.write( f'    mupdf_EXPORT {classname}({structname}* internal=NULL);\n')
    else:
        out_h.write( f'    mupdf_EXPORT {constructor_decl};\n')

    out_cpp.write( f'mupdf_EXPORT {classname}::{constructor_decl}\n')
    if extras.pod == 'inline':
        pass
    elif extras.pod:
...
def class_destructor(
    ...
    if len(destructor_fns):
        ...
        out_h.write( f'    mupdf_EXPORT ~{classname}();\n');

        out_cpp.write( f'mupdf_EXPORT {classname}::~{classname}()\n')
        out_cpp.write(  '{\n')
