...
Generated files:
    ...
    build/  [Generated by '-b m13']
        shared-release/     [Unix runtime files.]
            ...
            mupdfcsharpswig.so  [MuPDF C# internals.]
            mupdf.cs            [MuPDF C#.]
        ...
        shared-release-x32-py3.8/   [Windows runtime files.]
            ...
            mupdfcsharpswig.dll     [MuPDF C# internals.]
            mupdf.cs                [MuPDF C#.]
    ...
    for action in actions:
        with jlib.LogPrefixScope( f'{action}: '):
            ...
            if 0:
                ...
                if build_csharp:
                    jlib.log( 'Compiling/linking generated C# source code to create mupdfcsharpswig.{"dll" if g_windows else "so"} ...')
                ...
                if g_windows:
                    ...
                    if build_python:
                        ...
                        out_so = f'{build_dirs.dir_so}/mupdfcsharpswig.so'
