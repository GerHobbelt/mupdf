...
Example usage:
    ...
    PYTHONPATH=build/shared-release-extract ./scripts/mupdfwrap_gui.py foo.pdf
'''
...
def main():
    ...
    # Avoid diagnostics on stderr whenever we cause an fz exception, e.g. when
    # stepping to page that doesn't exist.
    #
    mupdf.set_warning_callback(None, None)
    mupdf.set_error_callback(None, None)
