...
int gmock_output_test_main(int argc, char** argv);
int gmock_test_main(int argc, char** argv);
int gmock_spec_builders_test_main(int argc, char** argv);
int gmock_spec_builders_test_main(int argc, char** argv);
int gmock_stress_test_main(int argc, char** argv);
