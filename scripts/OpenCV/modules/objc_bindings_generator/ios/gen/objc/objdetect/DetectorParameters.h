...
#import "W:/Projects/sites/library.visyond.gov/80/lib/tooling/qiqqa/MuPDF/thirdparty/owemdjee/opencv\modules/objdetect\include\opencv2\objdetect\aruco_detector.hpp"
#else
#define CV_EXPORTS
#endif
...
@property double minMarkerDistanceRate;
    ...
    //
    // C++: CornerRefineMethod cv::aruco::DetectorParameters::cornerRefinementMethod
    //

@property CornerRefineMethod cornerRefinementMethod;
