...
#if defined(_WIN32)
#define CATCH_CONFIG_COLOUR_WIN32  1
#endif
...
#define CATCH_CONFIG_CPP11_TO_STRING 1
...
#define CATCH_CONFIG_CPP17_BYTE 1
...
#define CATCH_CONFIG_CPP17_OPTIONAL  1
...
#define CATCH_CONFIG_CPP17_STRING_VIEW 1
...
#define CATCH_CONFIG_CPP17_UNCAUGHT_EXCEPTIONS   1
...
#define CATCH_CONFIG_CPP17_VARIANT  1
...
#define CATCH_CONFIG_GLOBAL_NEXTAFTER  1
...
#if !defined(_WIN32)
#define CATCH_CONFIG_POSIX_SIGNALS 1
#else
...
#if !defined(CATCH_CONFIG_NO_PREFIX_ALL)
...
// set this one to DISABLE static_assert() tests; useful for monolithic test code builds,
// where we would rather not have those compile-time *intentional* test failures:
// this would be the big monolithic test build after all. ;-)
...
#if 0
#define CATCH_CONFIG_FALLBACK_STRINGIFIER(value) @CATCH_CONFIG_FALLBACK_STRINGIFIER@
#endif
